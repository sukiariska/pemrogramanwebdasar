        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah Costumer</button>
                </div>
            </div>
...
<div class="modal fade" id="ModalTambahUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <option value="">Sistem</option>
        ...
        <label for="floatingInput">Level Costumer</label>
        <div class="invalid-feedback">
        Pilih Level Costumer.
        </div>
    </div>
        </div>
        <div class="col-lg-8">
...
<div class="form-floating">
        <textarea class="form-control" id="" style="height: 100px " name="alamat"></textarea>
    <label for="floatingInput">JK</label>
</div>
<div class="form-floating">
        <textarea class="form-control" id="" style="height: 100px " name="alamat"></textarea>
