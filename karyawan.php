...
<div class="modal-footer">
    ...
    <div class="col-lg-6">
    <div class="form-floating mb-3">
    <input disabled type="text" class="form-control" id="floatingInput" placeholder="JenisKelamin" name="JenisKelamin" value="<?php echo $row['JK'] ?>">
...
<!-- Akhir Modal view-->
    ...
    <div class="col-lg-6">
                    <div class="form-floating mb-3">
                    <select class="form-select" aria-label="Default select example" name="JenisKelamin" required value="<?php echo $row['JK'] ?>">
